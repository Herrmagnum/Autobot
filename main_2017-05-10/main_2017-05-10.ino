...
//double consKp=0.3, consKi=1.3, consKd=20;
double aggKp=0.889, aggKi=0, aggKd=0.234;
...
void SetSteering(){
  ...
  ServoWrite= 87.5-1.242*Output;
  ServoWrite2= 87.5+2.2*Output;
  myPID.Compute();
...
//                                            motor.write(angle);
                                            ...
                                            ServoWrite= 87.5-1.242*Alpha;
                                            ServoWrite2= 87.5+2.2*Alpha;
                                            FrontSteering.write(ServoWrite);
                                            BackSteering.write(ServoWrite2);
                                            passeringar=0;
